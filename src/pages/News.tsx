...
import { Search, ArrowRight, Calendar, User, ArrowUpRight } from 'lucide-react';
          ...
          <div className="mt-24 p-12 rounded-3xl bg-neutral-900 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
                ...
                />
                <button className="bg-white text-neutral-900 px-8 py-3 rounded-full font-bold hover:bg-neutral-100 transition-colors whitespace-nowrap">
                  Subscribe
                </button>
              </div>
            </div>
